...
SomeSign.Text = "Script by FourHub"
...
YoutubeTextBox.Text = "https://www.youtube.com/channel/@jokerbiel13"
...
DiscordTextBox.Text = "https://discord.gg/cUwR4tUJv3"
		...
		for _, plr in pairs(PS:GetPlayers()) do
			if plr.Character then
				...
				if HumanoidRootPart then
					local Esp1 = HumanoidRootPart:FindFirstChild("FourHubPlrBil")
					local Esp2 = HumanoidRootPart:FindFirstChild("FourHubPlrEsp")
					...
					if not Esp1 and not Esp2 then
						...
						BillboardGui.Name = "FourHubPlrBil"
	...
	if ItemEspToggle == false then
		...
		for _, v in pairs(Workspace:GetDescendants()) do
			if v:IsA("Model") and v:GetAttribute("ItemName") ~= nil then
				...
				BillboardGui.Name = "FourHubItemBil"
...
local function AlreadyTakenCheck(Obj)
	...
	if Obj:GetAttribute("FourHubAlreadyTakenPhoto") == true then
		AlreadyTaken = true
	end
	return AlreadyTaken
end
